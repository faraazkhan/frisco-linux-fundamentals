// All Credit for this to the awesome Jessie Frazelle
//
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
...
static int child_exec(void *stuff)
{
  ...
  // sethostname
  const char * new_hostname = "mylittlecontainer";
...
int main(int argc, char **argv)
{
  ...
  int clone_flags = CLONE_NEWUTS | CLONE_NEWIPC | CLONE_NEWNS | SIGCHLD;
